...
class SmtModel(BaseModel, EnsembleModule):
    def setup(self, params, logger=None):
        ...
        """
        super(SmtModel, self).setup(params, logger)
    ...
    def setup_module(self, params):
        ...
        super(SmtModel, self).setup_ensemble_module(params)
    ...
    def generate_update_dict(self, input_data, input_labels=None, batch_step=0):
        update_dict = super(SmtModel, self).generate_update_dict(input_data,
