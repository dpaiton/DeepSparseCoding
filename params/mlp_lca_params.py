...
class params(BaseParams):
  ...
  def set_data_params(self, data_type):
    ...
    if data_type.lower() == "cifar10":
      ...
      self.lca_stride_y = 2
      self.lca_stride_x = 2
      self.lca_patch_size_y = 8
      self.lca_patch_size_x = 8

      self.lca_max_pool = True
      self.lca_max_pool_ksize = (1, 5, 5, 1)
      self.lca_max_pool_strides = (1, 4, 4, 1)
      ...
      self.load_dict = True
      self.cp_load = True
      self.cp_load_name = "lca_conv_cifar10_0.05"
      self.cp_load_var = ["lca_conv/weights/w:0"]
      #self.cp_load_name = "lca_cifar10_patches_1.5"
      #self.cp_load_var = ["lca/weights/w:0"]
      ...
      self.model_name += "_" + str(sparse_mult)+"_"+str(num_sup_layers+1)+"_layer_load_from_"+self.cp_load_name
